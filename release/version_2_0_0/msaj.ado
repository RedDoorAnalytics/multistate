...
/*	
	...
	*/
	...
	tempname Nrisk Nevents Nevents_tot Nrisk_tot alpha_gh alpha_gg t_rank touse_t touse_all
...
// get data in right structure
	qui bysort  `touse' _t _from _trans `by': gen `touse_t' = _n==1 & `touse'
